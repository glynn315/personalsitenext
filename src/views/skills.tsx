export default function About() {
    return (
        <div id="technologies" className="h-dvh max-w-[1366px] w-full top-0 z-10 flex items-center p-20">
            <div className="mt-16 flex flex-col justify-center items-center w-full">
                <div className=" w-full flex flex-col">
                    <span className="headingShadow text-[80px] font-extrabold opacity-20 leading-none">TECHNOLOGIES</span>
                    <span className="heading text-[50px] -mt-12 font-extrabold leading-none text-white z-20">Technologies Used</span>
                ...
                <div className="w-full flex justify-start gap-2 items-center flex-wrap gap-y-10 mt-16"> 
                    <div className="frontendDisplay flex flex-row w-full justify-between items-center">
                        <div className="w-1/3">
                            <span className="text-2xl text-white font-bold">Frontend Development</span>
                        </div>
                        <div className="fontendContainer w-2/3 flex flex-row flex-wrap justify-start items-center gap-4 border-l-2 border-white pl-4">
                    ...
                    <div className="backendDisplay flex flex-row w-full justify-between items-center">
                        <div className="w-1/3">
                            <span className="text-2xl text-white font-bold">Backend Development</span>
                        </div>
                        <div className="backendContainer w-2/3 flex flex-row justify-start items-center gap-4 border-l-2 border-white pl-4">
                    ...
                    <div className="databaseDisplay flex flex-row w-full justify-between items-center">
                        <div className="w-1/3">
                            <span className="text-2xl text-white font-bold">Database</span>
                        </div>
                        <div className="databaseContainer w-2/3 flex flex-row justify-start items-center gap-4 border-l-2 border-white pl-4">
                    ...
                    <div className="creativesDisplay flex flex-row w-full justify-between items-center">
                        <div className="w-1/3">
                            <span className="text-2xl text-white font-bold">Creatives</span>
                        </div>
                        <div className="creativesContainer w-2/3 flex flex-row justify-start items-center gap-4 border-l-2 border-white pl-4">
