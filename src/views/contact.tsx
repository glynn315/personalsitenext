    ...
    return(
        <div id="contact"  className=" bg-slate-600 w-full top-0 z-10 flex flex-col items-center">
            ...
            <div className="w-2/4 flex justify-center items-center">
                <h1 className="font-extrabold text-[50px] text-white">Want to Connect?</h1>
            </div>
            ...
            <div className="footer p-7">
            <div className="w-[1366px] flex justify-between items-center text-white">
